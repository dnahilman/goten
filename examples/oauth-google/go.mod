module github.com/dnahilman/goten/examples/oauth-google
...
require (
	...
	github.com/dnahilman/goten/plugins/oauth v0.0.0
...
replace (
	...
	github.com/dnahilman/goten/plugins/oauth => ../../plugins/oauth
)
